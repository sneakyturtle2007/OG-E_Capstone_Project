namespace TheAndersonProject.Services
{
    public class SiteData{
        ...
        public static int[] YearMonth {get; set;} = new int[2]{0, 0}; 
        public static Dictionary<string, int> ReaderMaintenance = new Dictionary<string, int>();
        public static Dictionary<string, int> PanelMaintenance = new Dictionary<string, int>();
